...
namespace TelloSharp
{
    public class Tello
    {
        ...
        UdpListener videoServer = new UdpListener(6040);

        public FlyData state = new FlyData();
        ...
        private CancellationTokenSource cancelTokens = new CancellationTokenSource();//used to cancel listeners
